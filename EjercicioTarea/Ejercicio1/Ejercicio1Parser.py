...
class Ejercicio1Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "IDT", "NUM", "MAS", "WS" ]
    ...
    class RootContext(ParserRuleContext):
        ...
        def expr(self):
            return self.getTypedRuleContext(Ejercicio1Parser.ExprContext,0)
        ...
        def getRuleIndex(self):
            return Ejercicio1Parser.RULE_root
    ...
    def root(self):
        ...
        localctx = Ejercicio1Parser.RootContext(self, self._ctx, self.state)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return Ejercicio1Parser.RULE_expr
    ...
    def expr(self):
        ...
        localctx = Ejercicio1Parser.ExprContext(self, self._ctx, self.state)
