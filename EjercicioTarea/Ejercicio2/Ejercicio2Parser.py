...
class Ejercicio2Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "IDT", "NUM", "SUB", "WS" ]
    ...
    class RootContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(Ejercicio2Parser.EOF, 0)

        def getRuleIndex(self):
            return Ejercicio2Parser.RULE_root
    ...
    def root(self):
        ...
        localctx = Ejercicio2Parser.RootContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.expr()
            self.state = 5
            self.match(Ejercicio2Parser.EOF)
