...
class ifParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'if'", "'[A-Za-z]+'", "'>'", "<INVALID>", 
                     "'+'" ]

    symbolicNames = [ "<INVALID>", "IF", "IDT", "MAYOR_QUE", "NUM", "MAS", 
                      "WS" ]
    ...
    def root(self):
        ...
        localctx = ifParser.RootContext(self, self._ctx, self.state)
    ...
    def expr(self):
        ...
        localctx = ifParser.ExprContext(self, self._ctx, self.state)
